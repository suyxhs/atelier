  ...
  return (
    <>
      ...
      <div id="gallery" className={S.gallery}>
        <Helmet>
          <title>Галерея работы</title>
          <meta name="description" content="Работы которыми мы гордимся | Ателье" />
          <meta
            name="keywords"
            content="работы, примеры работ, отзывы ателье, воронеж, ателье-воронеж"
          />
